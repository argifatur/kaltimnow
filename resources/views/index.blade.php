					...
					<div class="col-12 main-val">
							...
							<div class="col-12 val-content pbot bbot main-slider">
									<div class="col-12 slider">
										@foreach($slides as $slide)
											<div class="oslide"><img src="public/img/{{ $slide->foto }}" class="foto-main"></div>
										@endforeach
										<div class="oslide"><img src="public/img/{{ $slides[0]->foto }}" class="foto-main"></div>
									</div>
						...
						@foreach ($beritas as $berita)
							...
							<div class="col-12 val-content pbot bbot">
									...
									<div class="col-2 col-xs-1 pad1"><img src="public/img/{{ $berita->foto }}"></div>
					...
					<div class="col-12 main-val">
						@foreach($beritaSaran as $berita)
							<div class="col-4 col-lg-10 val-content">
								...
								<div class="col-12 col-lg-2"><img src="portal/img/{{ $berita->foto }}" class="berita-bot"></div>
								<div class="col-12">
									<?php
										$controller->kategori($berita->kategori);
										$controller->tanggal($berita->created_at);
